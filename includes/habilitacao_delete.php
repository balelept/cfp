...
while($row = mysqli_fetch_assoc($registo))
    {
     ?>
     <form method="post" action="habilitacao_delete.php?d=2&id=<?php echo $id ?>">
     <tr>
     <td>ID do centro: </td>
     ...
     <input type="text" name="nome"  value="<?php echo $nome?>" readonly="readonly">
       ...
       <tr>
    <td colspan="2" align="center"><input type="submit" class="botao2" value="Apagar Habilitação" name="btn-signup">  </td>
    </tr>
          </form>
     <?php
    }?>
...
<?php } else { ?>
  <table align="center">
     ...
     <?php
     $a="habilitacao.php";
     $apagar = "DELETE FROM habilitacao WHERE id_habilitacao='$id'";
