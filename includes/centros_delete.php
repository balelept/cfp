...
<td align="center" bgcolor="#F08143"><font size="6" color="white">Centros de formacao</font></td>
</tr>
</table>
<br>
<?php
...
while($row = mysqli_fetch_assoc($registo))
    {
     ?>
     <form method="post" action="centros_delete.php?d=2&id=<?php echo $id ?>">
     <tr>
     <td>ID do centro: </td>
...
<?php } else { ?>
  <table align="center">
     ...
     <?php
     $a="centros.php";
     $apagar = "DELETE FROM cfp WHERE id_cfp='$id'";
