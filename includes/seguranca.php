...
$_SG['banco'] = 'db_portal';            // Banco de dados MySQL
$_SG['paginaLogin'] = 'inicio.php'; // Página de login
$_SG['tabela'] = 'utilizador';       // Nome da tabela onde os usuários são salvos
// ==============================
// ======================================
...
function conec(){
    $con = new mysqli("localhost", "root", "", "db_portal");
    return $con;
}
...
function validaUsuario($usuario, $senha) {
  ...
  die("Login incorrecto");
    ...
    $_SESSION['usuario'] = $resultado['usuario']; // Pega o valor da coluna 'nome' do registro encontrado no MySQL
