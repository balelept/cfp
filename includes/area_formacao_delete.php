...
<td align="center" bgcolor="#F08143"><font size="6" color="white">Área formaçao</font></td>
</tr>
</table>
<br>
<?php
...
while($row = mysqli_fetch_assoc($registo))
    {
     ?>
     <form method="post" action="area_formacao_delete.php?d=2&id=<?php echo $id ?>">
     <tr>
     <td>ID da area formacao: </td>
...
<?php } else { ?>
  <table align="center">
     ...
     <?php
     $a="area_formacao.php";
     $apagar = "DELETE FROM area_formacao WHERE id_area_formacao='$id'";
